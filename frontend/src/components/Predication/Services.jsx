      ...
      <div className="services-container">
        ...
        <div className="service-grid">
          <div className="service-card">
            ...
            <p>Check your pending fines by entering your vehicle/license number.</p>
            <button>Check Fine</button>
          </div>

          <div className="service-card">
            <h2>Online Fine Payment</h2>
            <p>Pay your fines securely via credit/debit cards, or mobile banking.</p>
          ...
          <div className="service-card">
            ...
            <p>Stay updated on traffic laws, penalties, and road safety rules.</p>
